class Coupon {
  ...
  Coupon.fromJson(Map<String, dynamic> json) {
    ...
    applicableCategory = json['applicableCategory'] != null
        ...
        : null;
    applicableUsers = json['applicableUsers'] != null
        ? new CatRef.fromJson(json['applicableUsers'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.applicableUsers != null) {
      data['applicableUsers'] = this.applicableUsers!.toJson();
    }
