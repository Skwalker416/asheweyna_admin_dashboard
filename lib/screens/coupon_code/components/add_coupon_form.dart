                ...
                children: [
                    ...
                    child: Consumer<CouponCodeProvider>(
                      builder: (context, couponProvider, child) {
                        return CustomDropdown(
                          ...
                          onChanged: (newValue) {
                            if (newValue != null) {
                              couponProvider.selectedUsers = null;
                  ...
                  Expanded(
                    child: Consumer<CouponCodeProvider>(
                      builder: (context, couponProvider, child) {
                        return CustomDropdown(
                          initialValue: couponProvider.selectedUsers,
                          hintText: couponProvider.selectedUsers?.name ??
                              'Select sub category',
                          ...
                          onChanged: (newValue) {
                            if (newValue != null) {
                              ...
                              couponProvider.selectedProduct = null;
                              couponProvider.selectedUsers = newValue;
                              couponProvider.updateUi();
                            }
                          },
                        );
